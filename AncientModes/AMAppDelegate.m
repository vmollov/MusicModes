...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    //prepare ads
    if(![[NSUserDefaults standardUserDefaults] boolForKey:@"enableAdvancedModes"]) [UIViewController prepareInterstitialAds];
...
- (void)applicationWillEnterForeground:(UIApplication *)application{
    ...
    [[AMScalesPlayer getInstance] setup];
}
...
- (NSManagedObjectModel *)managedObjectModel{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"AMAncientModesData" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"AMAncientModesData.sqlite"];
    NSLog(@"%@", storeURL);
    NSError *error = nil;
